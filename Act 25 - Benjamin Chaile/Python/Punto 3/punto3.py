...
def cargar_pilotos():
    ...
    for i in range(4):
        ...
        t1 = float(input("Ingrese el tiempo de la vuelta 1 (segundos): "))
        t2 = float(input("Ingrese el tiempo de la vuelta 2 (segundos): "))
        t3 = float(input("Ingrese el tiempo de la vuelta 3 (segundos): "))
