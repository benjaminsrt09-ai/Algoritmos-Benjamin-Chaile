...
def cargar():
    ...
    for i in range(5):
        nombre = input(f"Ingrese el nombre del {i+1}° producto: ")
        precio = int(input(f"Ingrese el precio del {i+1}°producto "))
        stock = int(input(f"Ingrese el stock del {i+1}° producto: "))
